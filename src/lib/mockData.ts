...
export const requests: PurchaseRequest[] = [
  ...
  },
  {
    ...
    description: 'Team collaboration and documentation platform with API integrations to existing tools',
    requestType: 'new_purchase',
    category: 'saas',
    department: 'business_operations',
    redundancyCheckConfirmed: true,
    ...
    status: 'pending',
    urgency: 'low',
    businessJustification: 'Centralized documentation and project tracking to replace fragmented tools.',
    requesterId: '3',
...
export const contracts: Contract[] = [
  {
    ...
    contractEndDate: '2029-01-14',
    contractTermMonths: 36,
    signedDate: '2026-01-12',
    signedByUserId: '2',
    signedByUserName: 'Sarah Chen',
    renewalAlertDate: '2028-10-16',
  ...
  },
  {
    ...
    contractEndDate: '2027-01-24',
    contractTermMonths: 12,
    signedDate: '2026-01-10',
    signedByUserId: '2',
    signedByUserName: 'Sarah Chen',
    renewalAlertDate: '2026-10-26',
    renewalInitiated: false,
    annualValue: 4800,
  },
  {
...
export const vendors: Vendor[] = [
  ...
  },
  {
    ...
    ownerId: '4',
    ownerName: 'Emily Brown',
    contractStart: '2026-01-30',
    contractEnd: '2027-01-29',
    annualSpend: 3200,
    autoRenew: true,
    status: 'active',
  ...
  },
  {
    ...
    contractStart: '2026-01-25',
    contractEnd: '2027-01-24',
    annualSpend: 4800,
    autoRenew: true,
    status: 'active',
...
export const renewals: Renewal[] = [
  ...
  // Additional renewals from different requesters
  {
    id: 'REN-009',
    vendorId: 'VEN-012',
